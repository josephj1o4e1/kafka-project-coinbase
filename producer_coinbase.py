...
URI = 'wss://ws-direct.sandbox.exchange.coinbase.com' # 'wss://ws-feed-public.sandbox.exchange.coinbase.com'
SIGNATURE_PATH = '/users/self/verify' # path of the API endpoint.

# Confluent Kafka
with open('terraform_test/terraform.tfstate') as f:
...
SCHEMA_REGISTRY_URL = config['outputs']['confluent_schema_registry_url']['value']
SCHEMA_REGISTRY_API_KEY = config['outputs']['confluent_schema_registry_api_key_id']['value']
SCHEMA_REGISTRY_API_SECRET = config['outputs']['confluent_schema_registry_api_key_secret']['value']
BOOTSTRAP_SERVERS = config['outputs']['confluent_kafka_bootstrap']['value'] # .replace('SASL_SSL://', '')
CLUSTER_API_KEY = config['outputs']['confluent_kafka_api_key_id']['value']
CLUSTER_API_SECRET = config['outputs']['confluent_kafka_api_key_secret']['value']
KAFKA_TOPIC = config['outputs']['confluent_kafka_topic_name']['value']
